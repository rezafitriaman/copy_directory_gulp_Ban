...
$('.banner').show();
	...
	{
				//FIX VOOR LEADERBOARD
			
			$('.ctaWrapper').css({'width' : 'auto','right' : '20px','bottom':'10px'});
			$('.logoWrapper').css({'width' : '150','left' : '20px','bottom':'15px','top': '12px','height' : '30px'});
			$('.copy1Wrapper').css({'width' : '120px'});
...
if(theme == 'Template1')
{
		$('#background1').css('left','150px');
	//custom fix voor leaderboard
			$('.ctaWrapper').css({'width' : 'auto','right' : '25px','bottom':'8px'});
			$('.logoWrapper').css({'width' : '150','left' : '5px','bottom':'15px','left' : 'auto','top': '12px'});
			$('.copy1Wrapper').css('width','145px');
			
	
	if(zoom == 'zoomIn')
	{
		$('.background1img').css({'transform' : 'scale(1)','left' : '150px'});
	}
	else if(zoom == 'zoomOut' )
	{
			$('.background1img').css({'transform' : 'scale('+zoomScale+')','left' : 0+'px','top': '-10px'});
	}
...
{
	//custom fix voor leaderboard
			$('.ctaWrapper').css({'width' : 'auto','right' : '25px','bottom':'10px'});
			$('.logoWrapper').css({'width' : '150','left' : '5px','bottom':'15px','left' : 'auto','top': '12px'});
			$('.copy1Wrapper').css('width','100px');
