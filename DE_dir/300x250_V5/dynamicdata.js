...
if (Enabler.isInitialized()) {init();} else {Enabler.addEventListener(studio.events.StudioEvent.INIT, init);}
	...
	function init()
	{
		...
		if(development == true)
		{
			...
			devDynamicContent.GStar_DE_dynamic_feed_Blad1= [{}];
			 var prefix = devDynamicContent.GStar_DE_dynamic_feed_Blad1[0];
			 window.prefix = prefix;
			prefix._id = 0;
			prefix.UniqueID = 1;
			prefix.Reporting_Label = "test1";
			prefix.Banner_Type = "Normaal";
			...
			prefix.Background1.Url = "https://s0.2mdn.net/ads/richmedia/studio/pv2/61026655/dirty/background.jpg";
			prefix.BackgroundTheme1 = {};
			prefix.BackgroundTheme1.Url = "background.jpg";
			prefix.Background2 = {};
			...
			prefix.AnimationPos = "rightBottom";
		...
		{  
			 var prefix =  dynamicContent.GStar_DE_dynamic_feed_Blad1[0];
			  window.prefix = prefix;
		}
