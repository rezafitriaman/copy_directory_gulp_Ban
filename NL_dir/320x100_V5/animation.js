				...
				$('.gallery-cell').css('background',prefix.Sliderbg);
				 ...
				 $('.gallery').flickity({
					  ...
					  wrapAround: true
						...
						$('.copy1Wrapper').find('.copy1').css({'display':'none'});
						$('.ctaWrapper').css({'display':'none'});
	}
...
if(theme == 'Template1')
{
	if(zoom == 'zoomIn')
	{
		$('.background1img').css({'transform' : 'scale(1)','left' : '0px','top' : theme1HeightTop-10});
	}
	else if(zoom == 'zoomOut' )
	{
			$('.background1img').css({'transform' : 'scale('+zoomScale+')','left' : ZoomOutXT1+'px','top' : +theme1HeightTop-10+'px'});
	}
