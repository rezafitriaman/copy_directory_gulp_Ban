...
if (Enabler.isInitialized()) {init();} else {Enabler.addEventListener(studio.events.StudioEvent.INIT, init);}
	...
	function init()
	{
		...
		if(development == true)
		{
			...
			devDynamicContent.GStar_AU_dynamic_feed_Blad1= [{}];
			 var prefix = devDynamicContent.GStar_AU_dynamic_feed_Blad1[0];
		...
		{  
			 var prefix =  dynamicContent.GStar_AU_dynamic_feed_Blad1[0];
			  window.prefix = prefix;
		}
